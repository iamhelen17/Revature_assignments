...
class PlayerSearchServiceImplTest {
	...
	public static void setupPlayerSearchServiceImpl() {
		services = new PlayerSearchServiceImpl();        //instance of that class has been created
	}
	
	
	@Test
	public void testGetPlayerById() {
		Player player = new Player(100, "Sachin", 33, "M", 1234567890, null, "Rockers");    //expected output
		try {
			assertEquals(player, services.getPlayerById(100));
	...
	@Test
	public void testGetPlayerByContact() {
